...
select 
  distinct book_category 
from 
  books;
insert into publisher(publisher_name) 
select 
  distinct book_publisher 
from 
  books;
insert into shape(shape_name) 
select 
  distinct book_format 
from 
  books;
insert into book(
  book_item, book_novelty, book_name, 
  book_price, book_pages, book_date, 
  book_circulation, theme_id, category_id, 
  publisher_id, shape_id
) 
select 
  book_item, 
  book_novelty, 
